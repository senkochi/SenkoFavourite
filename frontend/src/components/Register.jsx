...
const Register = (props) => {
    ...
    const isButtonDisabled = !props.email || props.loading;
    const fail = props.fail;

  return (
    <div>
        <form class="max-w-md md:ml-auto w-full" onSubmit={props.handleRegister}>
            ...
            <div className ="!mt-12">
              <button
                ...
                ${isButtonDisabled ? 'bg-blue-500 focus:outline-none' : ' bg-blue-600  hover:bg-blue-700 focus:outline-none cursor-pointer' }`}
                disabled={isButtonDisabled}
              >
                Continue
              </button>
              <p class="text-slate-600 text-sm mt-6 text-center">Already have an account? <a onClick={() => props.setRegister(false)} class="text-blue-600 font-medium hover:underline ml-1">Login here</a></p>
            </div>
