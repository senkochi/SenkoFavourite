              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                  <div className="lg:col-span-2 max-md:order-1">
                      ...
                      <div class="mt-8 max-w-lg">
                          ...
                          <form class="mt-12">
                              ...
                              <button type="button" class="mt-8 w-40 py-3 text-[15px] font-medium bg-purple-500 text-white rounded-md hover:bg-purple-600 tracking-wide cursor-pointer">Pay</button>
                          </form>
                      </div>
                  </div>
                  ...
                  <div class="bg-gray-100 p-6 rounded-md">
                      <ul class="text-slate-500 font-medium mt-8 space-y-4">
                          <li class="flex flex-wrap gap-4 text-sm">Subtotal <span class="ml-auto font-semibold text-slate-900">${subtotal}.00</span></li>
                          <li class="flex flex-wrap gap-4 text-sm">Shipping <span class="ml-auto font-semibold text-slate-900">${shipping}.00</span></li>
                          <li class="flex flex-wrap gap-4 text-[15px] font-semibold text-slate-900 border-t border-gray-300 pt-4">Total <span class="ml-auto">${total}.00</span></li>
                      </ul>
                  </div>
              </div>
          </div>
